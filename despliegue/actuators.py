...
sensors = [PirSensor]
sensors = [PirSensor, PirSensor2]
# sensors = [PirSensor,PhotoresistorSensor, PirSensor2 , PotentiometerSensor, InfraredSensor, SwitchSensor]

ip_pirSensor = "192.168.2.1"
ip_photoresistorSensor = "
ip_potentiometerSensor = "
ip_switchSensor = "
ip_infraredSensor = "

uri_pirSensor = f"http://{ip_pirSensor}:3001/ledDetectionActuator"
uri_pirSensor2 = f"http://{ip_photoresistorSensor}:3001/lightActuator"
uri_photoresistorSensor = f'http://{ip_photoresistorSensor}:3001/lightActuator'
uri_potentiometerSensor = f'http://{ip_potentiometerSensor}:3001/engineDCActuator'
uri_switchSensor = f'http://{ip_switchSensor}:3001/servmotorActuator'
uri_infraredSensor = f'http://{ip_infraredSensor}:3001/cameraActuator'
