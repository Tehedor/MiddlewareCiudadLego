...
async function generalSubsDraco() {
    try {
        // Buscar todas las entidades con la referencia especificada
        const entities = await EntitySubs.find({ "reference": "http://draco:5050/ld/notify"}, '_id entities conditions createdAt modifiedAt reference status count lastFailure lastNotification timesFailed');
...
module.exports = generalSubsDraco;